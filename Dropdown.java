...
public static void main(String[] args) {
    ...
    driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("11/07/1998");
    driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("madhusudannatarajan7@gmai.com");
    driver.findElement(By.id("createLeadForm_primaryPhoneNumber")).sendKeys("9952940583");
